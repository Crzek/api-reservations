package com.cruzerick.api_reservations.repository;
...
// Compoonete de SpringBoot
@Component
public class ReservationRepository {
    // Statico para que siga en memoria
    static List<Reservation> reservations = new ArrayList<>();

    // Metodos para poder guardar en memoria, trata como lista
